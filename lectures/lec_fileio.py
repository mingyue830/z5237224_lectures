...
# cnts_copy = ''  #important to remember. find line in fobj and read the first 20 characters, and print the type.
# for line in fobj:
#    cnts_copy += line
...
# ---------------------------------------------------------------------------- 
fobj = open(SRCFILE, mode='r') # open the document first

# Read the first line
# first_line = next(fobj) # read the next line
# print(first_line)
...
# ---------------------------------------------------------------------------- 
#   Using context managers like a box to help do not distinguish the codes
# ---------------------------------------------------------------------------- 
# Instead of fobj = open(SRCFILE, mode='r'), use a context manager:

# with open(SRCFILE, mode='r') as fobj:# context managers,
#    cnts = fobj.read()
...
# Exiting the context manager will close the file (will be recoverd)
